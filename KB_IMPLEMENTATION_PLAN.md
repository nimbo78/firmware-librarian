...
> **⚠ Исторический документ.** Это исходное техзадание базовой KB-подсистемы;
> она реализована и с тех пор расширена (каталог прошивок /fw + серии,
> LLM-экстракция с /review, оценки 👍/👎, петля gaps, админ-канал,
> vision/whisper/PDF-обогащение, контроль бюджета). Актуальное описание —
> [README.md](README.md) и [CLAUDE.md](CLAUDE.md); детали расхождений с этим
> планом смотри по git-истории. Хранится как контекст исходных решений.
